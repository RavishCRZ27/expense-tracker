...
14. [Sample Data & Live Query Results](#14-sample-data--live-query-results)
...
## 14. Sample Data & Live Query Results

> All data below was generated by running `python seed_demo.py` against the live PostgreSQL instance. Values are real outputs from the database.

### 14.1 — Demo Users (`SELECT * FROM users`)

| ID | Username | Email | Full Name | Admin | Expenses | Total Spent |
|---|---|---|---|---|---|---|
| 1 | string | string | — | No | 0 | ₹0.00 |
| 2 | tester1 | tester1@example.com | — | No | 2 | ₹2,500.00 |
| 3 | Ravish | ravishpandey27@gmail.com | Ravish Pandey | **Yes** | 0 | ₹0.00 |
| 4 | alice | alice@demo.com | Alice Sharma | No | 27 | ₹24,031.50 |
| 5 | bob | bob@demo.com | Bob Mehta | No | 26 | ₹20,926.98 |
| 6 | carol | carol@demo.com | Carol Nair | No | 28 | ₹45,024.15 |
| 7 | david | david@demo.com | David Rao | No | 25 | ₹38,928.00 |

**Demo user credentials:** `alice`, `bob`, `carol`, `david` — password: `demo1234`

---

### 14.2 — Global Category Distribution

> Query: `SELECT categories.name, SUM(expenses.amount), COUNT(expenses.id) FROM expenses JOIN categories ... GROUP BY categories.name ORDER BY total DESC`

| Category | Total Spent | Transactions |
|---|---|---|
| ✈️ Travel | ₹30,561.01 | 15 |
| 🛍️ Shopping | ₹24,075.85 | 16 |
| 🎬 Entertainment | ₹20,494.06 | 12 |
| 📚 Education | ₹19,463.26 | 12 |
| 🍔 Food | ₹15,484.89 | 21 |
| 📄 Bills | ₹12,426.57 | 16 |
| 💊 Health | ₹5,523.66 | 9 |
| 📦 Other | ₹3,381.33 | 7 |
| **TOTAL** | **₹1,31,410.63** | **108** |

**Observation:** Travel is the dominant spend category at 23.3% of total platform spending, despite having the fewest transactions (15), indicating high per-transaction values (avg ₹2,037). Food has the most transactions (21) but a lower average (₹737).

---

### 14.3 — Spending by User (LEFT OUTER JOIN result)

> Query: `SELECT users.username, COALESCE(SUM(expenses.amount), 0) ... FROM users LEFT OUTER JOIN expenses ... GROUP BY users.id ORDER BY total DESC`

| Rank | Username | Total Spent | Transactions |
|---|---|---|---|
| 1 | carol | ₹45,024.15 | 28 |
| 2 | david | ₹38,928.00 | 25 |
| 3 | alice | ₹24,031.50 | 27 |
| 4 | bob | ₹20,926.98 | 26 |
| 5 | tester1 | ₹2,500.00 | 2 |
| 6 | Ravish | ₹0.00 | 0 |
| 7 | string | ₹0.00 | 0 |

**Note the LEFT OUTER JOIN in action:** `Ravish` and `string` have zero expenses but still appear in the result set. An INNER JOIN would have excluded them entirely — losing platform-wide visibility into inactive users.

---

### 14.4 — Sample Expense Rows

> Query: `SELECT expenses.date, users.username, categories.name, expenses.amount, expenses.description FROM expenses JOIN categories JOIN users WHERE deleted_at IS NULL ORDER BY date DESC LIMIT 12`

| Date | User | Category | Amount | Description |
|---|---|---|---|---|
| 2026-04-15 | david | 🎬 Entertainment | ₹772.68 | Bowling & arcade |
| 2026-04-14 | david | 📄 Bills | ₹1,127.44 | Electricity bill |
| 2026-04-14 | david | 🛍️ Shopping | ₹6,256.65 | Amazon – electronics |
| 2026-04-14 | carol | 🎬 Entertainment | ₹1,206.20 | BookMyShow – concert |
| 2026-04-14 | bob | 💊 Health | ₹805.02 | Pharmacy – medicines |
| 2026-04-14 | bob | 🛍️ Shopping | ₹819.50 | Flipkart – home essentials |
| 2026-04-13 | david | 📦 Other | ₹375.55 | Laundry service |
| 2026-04-13 | tester1 | 🛍️ Shopping | ₹2,000.00 | New shoes |
| 2026-04-13 | tester1 | 🍔 Food | ₹500.00 | Dinner |
| 2026-04-09 | david | 💊 Health | ₹748.52 | Blood test – lab |
| 2026-04-09 | david | 📄 Bills | ₹119.00 | Spotify premium |
| 2026-04-08 | carol | 📄 Bills | ₹364.38 | Netflix subscription |

---

### 14.5 — Demo User Spending Profiles

Each demo user was seeded with a distinct spending personality to showcase varied analytics:

| User | Personality | High Categories |
|---|---|---|
| **Alice Sharma** | Foodie & Shopper | 🍔 Food (7 txns), 🛍️ Shopping (5 txns) |
| **Bob Mehta** | Frequent Traveller | ✈️ Travel (6 txns), 📄 Bills (4 txns) |
| **Carol Nair** | Health & Education focus | 📚 Education (5 txns), 💊 Health (4 txns) |
| **David Rao** | Bills-heavy, misc spender | 📄 Bills (5 txns), ✈️ Travel (4 txns) |

### 14.6 — Seeding the Demo Data

A dedicated seed script is included in the repository:

```bash
python seed_demo.py
```

The script is **idempotent** — it checks for existing usernames before inserting and skips duplicates safely. Run it once after applying Alembic migrations to populate the database with realistic demonstration data.
